...
--
-- Servidor: localhost
-- Tiempo de generación: 16-10-2022 a las 06:14:26
...
--
DROP DATABASE IF EXISTS `hiroito_sushi`;
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK de la tabla clientes, de tipo primary autoincremental.', AUTO_INCREMENT=23;
